	...
	var initToolTip = function() {
		...
		//$(document).ready(function() {
				...
				$('#password_policy').tooltipster({
					content: $('<p style="text-align:left;">Password must be at least 12  characters and must contain an upper case character, a lower case character, a numeric character, and a special character !@#$%^&*()</p>'),
					/*minWidth: 300,*/
					maxWidth: 300,
					position: 'top',
				    trigger: 'click'
